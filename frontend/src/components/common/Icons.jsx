/**
 * Joineazy SVG Icon Library
 * All icons are 24x24 viewBox, stroke-based (Heroicons style).
 * Usage: <BookIcon className="w-5 h-5 text-blue-600" />
 */
...
export const AcademicCapIcon = (p) => (
  <svg {...iconProps(p)}>
    <path strokeLinecap="round" strokeLinejoin="round"
...
export const ArrowDownTrayIcon = (p) => (
  <svg {...iconProps(p)}>
    <path strokeLinecap="round" strokeLinejoin="round"
